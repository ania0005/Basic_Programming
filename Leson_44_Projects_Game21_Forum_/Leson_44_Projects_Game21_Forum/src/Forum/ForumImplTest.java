...
import static org.junit.jupiter.api.Assertions.*;
    ...
    class ForumImplTest {
        ...
        void setUp() {
            ...
            posts[0] = new Post(1, "author1", "title1", "content");
            posts[1] = new Post(2, "author2", "title2", "content");
            posts[2] = new Post(3, "author2", "title3", "content");
            posts[3] = new Post(4, "author1", "title4", "content");
            posts[4] = new Post(5, "author3", "title1", "content");
            posts[5] = new Post(6, "author1", "title2", "content");
        ...
        @Test
        void addPost() {
           // posts[6] = new Post(7, "author1", "title2", "content");
